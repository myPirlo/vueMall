        ...
        <div class="checkout-page">
                ...
                <div class="container">
                    ...
                    <div class="addr-list-wrap">
                        <div class="addr-list">
                        <ul>
                            <li v-for="(item,index) in addressListFilter" :key="index" v-bind:class="{'check':checkIndex==index}" @click="checkIndex=index;addressId=item.addressId">
                                <dl>
                                    <dt>{{item.userName}}</dt>
                        ...
                        <a class="addr-more-btn up-down-btn" href="javascript:;" @click="showAllAdress" v-bind:class="{'open':limit>3}">
                            more
                            <i class="i-up-down">
                    ...
                    <div class="next-btn-wrap">
                        <router-link class="btn btn--m btn--red" v-bind:to="{path:'orderConfirm',query:{'addressId':addressId}}">Next</router-link>
                    </div>
                    </div>
                </div>
            </div> 
            <modal v-bind:mdShow="showDelMessage" v-on:close="closeModal">
                <p slot="message">
                    是否删除该地址
                </p>
                <div slot="btnGroup">  
                    <a class="btn btn--m"  href="javascript:;" @click="sureDel">确定</a>
                    <a class="btn btn--m"  href="javascript:;" @click="showDelMessage=false">取消</a>
